...
/**
 * WorkshopAdapter is used to view the Student perspective of Workshops in ViewEvent
...
public class WorkshopAdapter extends ArrayAdapter<WorkshopWord> {

    private Context mcontext;
    private FragmentManager fragmentManager;
    public WorkshopAdapter(Context context, ArrayList<WorkshopWord> words,FragmentManager fm) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (listItemView == null) {
            listItemView = LayoutInflater.from(getContext()).inflate(
                    R.layout.wor_listview, parent, false);
        }
        final WorkshopWord cword = getItem(position);
        assert cword != null;
        TextView Title =  listItemView.findViewById(R.id.s_title);
        Title.setText(cword.getTitle());
        TextView date =  listItemView.findViewById(R.id.s_date);
        TextView time =  listItemView.findViewById(R.id.s_time);
        ...
        TextView Venue =  listItemView.findViewById(R.id.s_venue);
        Venue.setText(cword.getVenue());

        TextView Club =  listItemView.findViewById(R.id.s_club);
        Club.setText(cword.getClub());

        TextView Org =  listItemView.findViewById(R.id.s_org);
        Org.setText(cword.getOrg());

        TextView Des =  listItemView.findViewById(R.id.s_des);
        Des.setText(cword.getDes());

        TextView fees =  listItemView.findViewById(R.id.s_fees);
        fees.setText(cword.getFees());

        ViewHolder holder;
        holder = new ViewHolder();
        holder.join =  listItemView.findViewById(R.id.join);
        holder.add_clender =  listItemView.findViewById(R.id.add_calender);
        holder.callbutton =  listItemView.findViewById(R.id.call);
        holder.view_poster =  listItemView.findViewById(R.id.view_poster);

        holder.view_poster.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(cword.getPoster().equals("true")){
                    PosterViewDialog post = new PosterViewDialog();
                    post.setCon("Workshop",cword.getId());
        ...
        holder.add_clender.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
